...
Senior software engineer experienced with backend, Actix Web, blockchain, systems, tokio, p2p networking, Rust, C++, and also Qt, Solidity, Move, Python, C, TypeScript/JavaScript.
